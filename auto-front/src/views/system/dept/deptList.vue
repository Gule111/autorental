<template>
  <div>
    <el-main>
      <el-form :inline="true" :model="deptModel" size="size" label-width="80px">
        ...
        <el-dialog :title="titleMap[dialogStatus]" :visible.sync="dialogFormVisible">
                <el-form :model="saveDept" :rules="rules" ref="form" label-width="80px" size="small">
                    <el-form-item label="上级部门" prop="parentName">
                      <el-input v-model="saveDept.parentName" placeholder="请输入上级部门名称" :readOnly="true" @click.native="selectDept"></el-input>
                    </el-form-item>
          ...
          <el-dialog title="选择上级部门" :visible.sync="dialogTreeVisible" width="30%">
            <el-tree :data="treeData" :props="defaultProps" @node-click="handleNodeClick" default-expand-all=true empty-text="未获取部门数据" :highlight-current="true">

            </el-tree>
            <div slot="footer" class="dialog-footer">
              <el-button @click="closTree">取 消</el-button>
